...
public class MetricsSupportUtil {
    ...
    private static final String[] NEW_PROMETHEUS_STACK = {
            ...
            "io.prometheus.metrics.exporter.httpurlconnection.HttpConnectionFactory",
            "io.prometheus.metrics.exporter.httpurlconnection.BasicAuthHttpConnectionFactory"
    };
    ...
    public static boolean isSupportPrometheus() {
        return isAllClassPresent(LEGACY_PROMETHEUS_STACK)
                || isAllClassPresent(NEW_PROMETHEUS_STACK);
    }
